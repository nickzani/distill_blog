...
future_games <- data.frame(home_team = c("Brighton", "Brentford", "Man United"),
                           away_team = c("Liverpool", "Burnley", "Tottenham"),
                           date = c("12/03/2022"))
...
saveRDS(modelFitWinner, file = "C:/Users/vi2073/Documents/GitHub/distill_blog/distill_nickzani/scripts/model.RDS")